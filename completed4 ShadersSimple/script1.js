...
void main(){
  ...
  // if(newPos.x<abs(5.0*sin(u_time/5.0 +3.14/2.0)) ){
  //   newPos=normal*1.1;
  // }

  vec3 origin=vec3(2.5,0.0,0.0);
  float d=distance(origin,newPos);
  newPos=normal*sin(d*2.0+u_time)*d;

  // newPos.z=   sin(dis*2.0 -u_time/1.0);
...
class sketch {
  ...
  addObject() {
    this.geometry = new THREE.SphereBufferGeometry(5,100 ,100);
    this.uniform={
